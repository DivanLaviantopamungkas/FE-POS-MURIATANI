...
import { ReactComponent as ProductIcon } from "./product-icon.svg?react";
import { ReactComponent as CategoryIcon } from "./categori-icon.svg?react";
import { ReactComponent as SupplierIcon } from "./supplier-icon.svg?react";
import { ReactComponent as PembelianIcon } from "./pembelian-icon.svg?react";
import { ReactComponent as PenjualanIcon } from "./penjualan-icon.svg?react";
import { ReactComponent as KasirIcon } from "./kasir-icon.svg?react";
